...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        //when
        Long orderId = orderService.saveOrder(member.getId(), book.getId(), orderCount);
    ...
    public void 상품주문_재고수량초과() throws Exception{
        ...
        //when
        orderService.saveOrder(member.getId(), book.getId(), orderCount);
    ...
    private Member createMember() {
        ...
        member.setName("수갱");
        member.setAddress(new Address("수원","강가","123-123"));
        em.persist(member);
        return member;
    }
